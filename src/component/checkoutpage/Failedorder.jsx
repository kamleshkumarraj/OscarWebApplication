...
import orderfailedImg from "../../assets/oscar_image/Illustration.svg";
...
const Failedorder = () => {
  return (
    <>
      ...
      <div className="w-full p-[20px] md:p-[52.62px] bg-[#FBD9D0] gap-[13.16px]">
        <h1 className='lg:text-xl text-sm font-semibold'>Failed Order</h1>
        ...
        <nav className="flex items-center gap-[10px] md:gap-[13.16px]" aria-label="Breadcrumb">
          ...
          <p className="text-red-500 text-sm md:text-base">Failed Order</p>
        </nav>
      </div>
      ...
      <div className="flex flex-col items-center justify-center px-4 mb-8">
        <img src={orderfailedImg} alt="Failed Order Illustration" className="mt-[100px] w-3/4 md:w-auto" />
    ...
    <button className=" mt-5 left-[860.38px] w-[172.61px] h-[57.89px] p-[15.79px_31.57px] flex items-center gap-[7.89px] bg-[#0E1422] rounded-[5.26px] text-white justify-center">Reorder <FaArrowRightLong /></button></div>
    </>
  );
};
